...
The project use mostly yarn for locking the packages and handling tasks, but feel free to use npm too since is 100% compatible.

In the project directory, you can run:

### `yarn install`

Required for installing all project dependencies.
